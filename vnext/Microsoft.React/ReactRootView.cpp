...
namespace winrt::Microsoft::React::implementation
{
	...
	//	{
	//		throw winrt::hresult_invalid_operation(L"Thread does not have dispatcher access.");
	//	}

	//	if (m_reactInstanceManager != nullptr)
	//	{
	//		throw winrt::hresult_invalid_operation(L"This root view has already been attached to an instance manager.");
	//	}
