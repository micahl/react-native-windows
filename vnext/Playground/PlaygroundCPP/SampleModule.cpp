...
IMapView<hstring, Microsoft::ReactNative::MethodDelegate>
SampleModule::Methods() {
  auto delegates =
      single_threaded_map<hstring, Microsoft::ReactNative::MethodDelegate>();
...
IMapView<hstring, Microsoft::ReactNative::MethodWithCallbackDelegate>
SampleModule::MethodsWithCallback() {
  auto delegatesWithCallback = single_threaded_map<
      hstring,
      Microsoft::ReactNative::MethodWithCallbackDelegate>();
  delegatesWithCallback.Insert(
      L"method2", [](hstring para, MethodCallback callback) {
